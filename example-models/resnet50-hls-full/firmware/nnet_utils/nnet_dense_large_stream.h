...
#ifndef NNET_LARGE_LAYER_STREAM_H_
#define NNET_LARGE_LAYER_STREAM_H_
...
void dense_large_nobias_stream_rf_leq_nin(
	...
	typename CONFIG_T::accum_t tmpmult[block_factor];
        ...
        for (int im = 0; im < block_factor; im++) {
         #pragma HLS UNROLL
  	    ...
  	    tmpmult[im] = product<data_T, typename CONFIG_T::weight_t, typename CONFIG_T::accum_t>(data[in_index], weights[im].read());
	    //w_index += rufactor;
	    in_index += rufactor;
            if (in_index >= nin) {
                in_index = ir;
...
template<class data_T, class res_T, typename CONFIG_T>
void dense_large_nobias_stream_rf_gt_nin_rem0(
    data_T data[CONFIG_T::n_in],
    res_T  res[CONFIG_T::n_out],
    hls::stream<typename CONFIG_T::weight_t> weights[CONFIG_T::block_factor]) { 
...
template<class data_T, class res_T, typename CONFIG_T>
void dense_large_nobias_stream_rf_gt_nin(
    data_T data[CONFIG_T::n_in],
    res_T  res[CONFIG_T::n_out],
    hls::stream<typename CONFIG_T::weight_t> weights[CONFIG_T::block_factor]) { 
...
template<class data_T, class res_T, typename CONFIG_T>
void dense_large_nobias_stream(
    data_T data[CONFIG_T::n_in],
    res_T  res[CONFIG_T::n_out],
    hls::stream<typename CONFIG_T::weight_t> weights[CONFIG_T::block_factor]) { 
  ...
  //    #pragma HLS INLINE region
    ...
    if (CONFIG_T::reuse_factor <= CONFIG_T::n_in) {
      dense_large_nobias_stream_rf_leq_nin<data_T, res_T, CONFIG_T>(data, res, weights); 
    } else if (CONFIG_T::reuse_factor % CONFIG_T::n_in == 0) {
      dense_large_nobias_stream_rf_gt_nin_rem0<data_T, res_T, CONFIG_T>(data, res, weights);
    } else {
      dense_large_nobias_stream_rf_gt_nin<data_T, res_T, CONFIG_T>(data, res, weights);
    }
}
