...
if {$opt(reset)} {
  open_project -reset myproject_prj_4thbit
} else {
  open_project myproject_prj_4thbit
}
set_top subimage
add_files firmware/myproject_4thbit.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_4thbit.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_4thbit.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
