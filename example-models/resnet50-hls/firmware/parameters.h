...
#define N_FILT_2 64
#define N_OUT_HEIGHT_2 56
#define N_OUT_WIDTH_2 56
...
struct config2 : nnet::conv2d_config {
    ...
    static const unsigned out_height = N_OUT_HEIGHT_2;
    static const unsigned out_width = N_OUT_WIDTH_2;
...
struct config5 : nnet::pooling2d_config {
    static const unsigned in_height = N_OUT_HEIGHT_2;
    static const unsigned in_width = N_OUT_WIDTH_2;
    ...
    static const unsigned out_height = N_OUT_HEIGHT_5;
    static const unsigned out_width = N_OUT_WIDTH_5;
