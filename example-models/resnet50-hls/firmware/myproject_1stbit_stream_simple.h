#ifndef MYPROJECT_1STBIT_STREAM_SIMPLE_H_
#define MYPROJECT_1STBIT_STREAM_SIMPLE_H_

#include <complex>
#include "ap_int.h"
#include "ap_fixed.h"

#include "parameters_1stbit_stream_simple.h"
...
void subimage_stream(bool iReset,
		     ...
		     hls::stream<result_t> layer176_out[N_FILT_41]);
#endif
