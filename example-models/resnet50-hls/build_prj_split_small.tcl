...
if {$opt(reset)} {
  open_project -reset myproject_prj_split_small
} else {
  open_project myproject_prj_split_small
}
set_top subimage
add_files firmware/myproject_split_small.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_split_small.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_split_small.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
