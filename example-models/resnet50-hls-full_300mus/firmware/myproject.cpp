...
void myproject_in(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_weightdefault_t, 9408>(w2, "w2.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b2, "b2.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 4096>(w6, "w6.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b6, "b6.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 36864>(w9, "w9.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b9, "b9.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 16384>(w12, "w12.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b12, "b12.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 16384>(w14, "w14.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b14, "b14.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 16384>(w18, "w18.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b18, "b18.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 36864>(w21, "w21.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b21, "b21.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 16384>(w24, "w24.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b24, "b24.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 16384>(w28, "w28.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b28, "b28.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 36864>(w31, "w31.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 64>(b31, "b31.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 16384>(w34, "w34.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b34, "b34.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 32768>(w38, "w38.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b38, "b38.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 147456>(w41, "w41.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b41, "b41.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w44, "w44.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b44, "b44.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 131072>(w46, "w46.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b46, "b46.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w50, "w50.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b50, "b50.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 147456>(w53, "w53.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b53, "b53.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w56, "w56.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b56, "b56.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w60, "w60.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b60, "b60.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 147456>(w63, "w63.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b63, "b63.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w66, "w66.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b66, "b66.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w70, "w70.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b70, "b70.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 147456>(w73, "w73.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 128>(b73, "b73.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 65536>(w76, "w76.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b76, "b76.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 131072>(w80, "w80.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b80, "b80.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 589824>(w83, "w83.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b83, "b83.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w86, "w86.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b86, "b86.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 524288>(w88, "w88.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b88, "b88.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w92, "w92.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b92, "b92.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 589824>(w95, "w95.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b95, "b95.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w98, "w98.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b98, "b98.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w102, "w102.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b102, "b102.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 589824>(w105, "w105.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b105, "b105.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w108, "w108.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b108, "b108.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w112, "w112.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b112, "b112.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 589824>(w115, "w115.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b115, "b115.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w118, "w118.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b118, "b118.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w122, "w122.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b122, "b122.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 589824>(w125, "w125.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b125, "b125.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w128, "w128.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b128, "b128.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w132, "w132.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b132, "b132.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 589824>(w135, "w135.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 256>(b135, "b135.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 262144>(w138, "w138.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1024>(b138, "b138.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 524288>(w142, "w142.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b142, "b142.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2359296>(w145, "w145.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b145, "b145.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1048576>(w148, "w148.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2048>(b148, "b148.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2097152>(w150, "w150.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2048>(b150, "b150.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1048576>(w154, "w154.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b154, "b154.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2359296>(w157, "w157.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b157, "b157.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1048576>(w160, "w160.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2048>(b160, "b160.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1048576>(w164, "w164.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b164, "b164.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2359296>(w167, "w167.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 512>(b167, "b167.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1048576>(w170, "w170.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2048>(b170, "b170.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 2048000>(w175, "w175.txt");
        nnet::load_weights_from_txt<model_weightdefault_t, 1000>(b175, "b175.txt");
        loaded_weights = true;
    }
#endif
    ...
    #pragma HLS STREAM variable=layer4_out depth=181 dim=1
    ...
    while(!layer177_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer177_t, layer8_t, config6>(layer177_out1, layer8_out, w6, b6);

    static hls::stream<layer11_t> layer11_out[N_FILT_9];
    #pragma HLS STREAM variable=layer11_out depth=59 dim=1
    while(!layer8_out[0].empty()) nnet::conv_2d_large_cl<layer8_t, layer11_t, config9>(layer8_out, layer11_out, w9, b9);

    static hls::stream<layer13_t> layer13_out[N_FILT_12];
    #pragma HLS STREAM variable=layer13_out depth=1 dim=1
    while(!layer11_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer11_t, layer13_t, config12>(layer11_out, layer13_out, w12, b12);

    static hls::stream<layer15_t> layer15_out[N_FILT_14];
    #pragma HLS STREAM variable=layer15_out depth=1 dim=1
    while(!layer177_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer177_t, layer15_t, config14>(layer177_out2, layer15_out, w14, b14);
    ...
    while(!layer178_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer178_t, layer20_t, config18>(layer178_out1, layer20_out, w18, b18);

    static hls::stream<layer23_t> layer23_out[N_FILT_21];
    #pragma HLS STREAM variable=layer23_out depth=59 dim=1
    while(!layer20_out[0].empty()) nnet::conv_2d_large_cl<layer20_t, layer23_t, config21>(layer20_out, layer23_out, w21, b21);

    static hls::stream<layer25_t> layer25_out[N_FILT_24];
    #pragma HLS STREAM variable=layer25_out depth=1 dim=1
    while(!layer23_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer23_t, layer25_t, config24>(layer23_out, layer25_out, w24, b24);
    ...
    while(!layer179_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer179_t, layer30_t, config28>(layer179_out1, layer30_out, w28, b28);

    static hls::stream<layer33_t> layer33_out[N_FILT_31];
    #pragma HLS STREAM variable=layer33_out depth=59 dim=1
    while(!layer30_out[0].empty()) nnet::conv_2d_large_cl<layer30_t, layer33_t, config31>(layer30_out, layer33_out, w31, b31);

    static hls::stream<layer35_t> layer35_out[N_FILT_34];
    #pragma HLS STREAM variable=layer35_out depth=1 dim=1
    while(!layer33_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer33_t, layer35_t, config34>(layer33_out, layer35_out, w34, b34);
    ...
    while(!layer180_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer180_t, layer40_t, config38>(layer180_out1, layer40_out, w38, b38);

    static hls::stream<layer43_t> layer43_out[N_FILT_41];
    #pragma HLS STREAM variable=layer43_out depth=31 dim=1
    while(!layer40_out[0].empty()) nnet::conv_2d_large_cl<layer40_t, layer43_t, config41>(layer40_out, layer43_out, w41, b41);

    static hls::stream<layer45_t> layer45_out[N_FILT_44];
    #pragma HLS STREAM variable=layer45_out depth=1 dim=1
    while(!layer43_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer43_t, layer45_t, config44>(layer43_out, layer45_out, w44, b44);

    static hls::stream<layer47_t> layer47_out[N_FILT_46];
    #pragma HLS STREAM variable=layer47_out depth=1 dim=1
    while(!layer180_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer180_t, layer47_t, config46>(layer180_out2, layer47_out, w46, b46);
    ...
    while(!layer181_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer181_t, layer52_t, config50>(layer181_out1, layer52_out, w50, b50);

    static hls::stream<layer55_t> layer55_out[N_FILT_53];
    #pragma HLS STREAM variable=layer55_out depth=31 dim=1
    while(!layer52_out[0].empty()) nnet::conv_2d_large_cl<layer52_t, layer55_t, config53>(layer52_out, layer55_out, w53, b53);

    static hls::stream<layer57_t> layer57_out[N_FILT_56];
    #pragma HLS STREAM variable=layer57_out depth=1 dim=1
    while(!layer55_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer55_t, layer57_t, config56>(layer55_out, layer57_out, w56, b56);
    ...
    while(!layer182_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer182_t, layer62_t, config60>(layer182_out1, layer62_out, w60, b60);

    static hls::stream<layer65_t> layer65_out[N_FILT_63];
    #pragma HLS STREAM variable=layer65_out depth=31 dim=1
    while(!layer62_out[0].empty()) nnet::conv_2d_large_cl<layer62_t, layer65_t, config63>(layer62_out, layer65_out, w63, b63);

    static hls::stream<layer67_t> layer67_out[N_FILT_66];
    #pragma HLS STREAM variable=layer67_out depth=1 dim=1
    while(!layer65_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer65_t, layer67_t, config66>(layer65_out, layer67_out, w66, b66);
    ...
    while(!layer183_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer183_t, layer72_t, config70>(layer183_out1, layer72_out, w70, b70);

    static hls::stream<layer75_t> layer75_out[N_FILT_73];
    #pragma HLS STREAM variable=layer75_out depth=31 dim=1
    while(!layer72_out[0].empty()) nnet::conv_2d_large_cl<layer72_t, layer75_t, config73>(layer72_out, layer75_out, w73, b73);

    static hls::stream<layer77_t> layer77_out[N_FILT_76];
    #pragma HLS STREAM variable=layer77_out depth=1 dim=1
    while(!layer75_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer75_t, layer77_t, config76>(layer75_out, layer77_out, w76, b76);
    ...
    while(!layer184_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer184_t, layer82_t, config80>(layer184_out1, layer82_out, w80, b80);

    static hls::stream<layer85_t> layer85_out[N_FILT_83];
    #pragma HLS STREAM variable=layer85_out depth=17 dim=1
    while(!layer82_out[0].empty()) nnet::conv_2d_large_cl<layer82_t, layer85_t, config83>(layer82_out, layer85_out, w83, b83);

    static hls::stream<layer87_t> layer87_out[N_FILT_86];
    #pragma HLS STREAM variable=layer87_out depth=1 dim=1
    while(!layer85_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer85_t, layer87_t, config86>(layer85_out, layer87_out, w86, b86);

    static hls::stream<layer89_t> layer89_out[N_FILT_88];
    #pragma HLS STREAM variable=layer89_out depth=1 dim=1
    while(!layer184_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer184_t, layer89_t, config88>(layer184_out2, layer89_out, w88, b88);
    ...
    while(!layer185_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer185_t, layer94_t, config92>(layer185_out1, layer94_out, w92, b92);

    static hls::stream<layer97_t> layer97_out[N_FILT_95];
    #pragma HLS STREAM variable=layer97_out depth=17 dim=1
    while(!layer94_out[0].empty()) nnet::conv_2d_large_cl<layer94_t, layer97_t, config95>(layer94_out, layer97_out, w95, b95);

    static hls::stream<layer99_t> layer99_out[N_FILT_98];
    #pragma HLS STREAM variable=layer99_out depth=1 dim=1
    while(!layer97_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer97_t, layer99_t, config98>(layer97_out, layer99_out, w98, b98);
    ...
    while(!layer186_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer186_t, layer104_t, config102>(layer186_out1, layer104_out, w102, b102);

    static hls::stream<layer107_t> layer107_out[N_FILT_105];
    #pragma HLS STREAM variable=layer107_out depth=17 dim=1
    while(!layer104_out[0].empty()) nnet::conv_2d_large_cl<layer104_t, layer107_t, config105>(layer104_out, layer107_out, w105, b105);

    static hls::stream<layer109_t> layer109_out[N_FILT_108];
    #pragma HLS STREAM variable=layer109_out depth=1 dim=1
    while(!layer107_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer107_t, layer109_t, config108>(layer107_out, layer109_out, w108, b108);
    ...
    while(!layer187_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer187_t, layer114_t, config112>(layer187_out1, layer114_out, w112, b112);

    static hls::stream<layer117_t> layer117_out[N_FILT_115];
    #pragma HLS STREAM variable=layer117_out depth=17 dim=1
    while(!layer114_out[0].empty()) nnet::conv_2d_large_cl<layer114_t, layer117_t, config115>(layer114_out, layer117_out, w115, b115);

    static hls::stream<layer119_t> layer119_out[N_FILT_118];
    #pragma HLS STREAM variable=layer119_out depth=1 dim=1
    while(!layer117_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer117_t, layer119_t, config118>(layer117_out, layer119_out, w118, b118);
    ...
    while(!layer188_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer188_t, layer124_t, config122>(layer188_out1, layer124_out, w122, b122);

    static hls::stream<layer127_t> layer127_out[N_FILT_125];
    #pragma HLS STREAM variable=layer127_out depth=17 dim=1
    while(!layer124_out[0].empty()) nnet::conv_2d_large_cl<layer124_t, layer127_t, config125>(layer124_out, layer127_out, w125, b125);

    static hls::stream<layer129_t> layer129_out[N_FILT_128];
    #pragma HLS STREAM variable=layer129_out depth=1 dim=1
    while(!layer127_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer127_t, layer129_t, config128>(layer127_out, layer129_out, w128, b128);
    ...
    while(!layer189_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer189_t, layer134_t, config132>(layer189_out1, layer134_out, w132, b132);

    static hls::stream<layer137_t> layer137_out[N_FILT_135];
    #pragma HLS STREAM variable=layer137_out depth=17 dim=1
    while(!layer134_out[0].empty()) nnet::conv_2d_large_cl<layer134_t, layer137_t, config135>(layer134_out, layer137_out, w135, b135);

    static hls::stream<layer139_t> layer139_out[N_FILT_138];
    #pragma HLS STREAM variable=layer139_out depth=1 dim=1
    while(!layer137_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer137_t, layer139_t, config138>(layer137_out, layer139_out, w138, b138);
    ...
    while(!layer190_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer190_t, layer144_t, config142>(layer190_out1, layer144_out, w142, b142);

    static hls::stream<layer147_t> layer147_out[N_FILT_145];
    #pragma HLS STREAM variable=layer147_out depth=10 dim=1
    while(!layer144_out[0].empty()) nnet::conv_2d_large_cl<layer144_t, layer147_t, config145>(layer144_out, layer147_out, w145, b145);

    static hls::stream<layer149_t> layer149_out[N_FILT_148];
    #pragma HLS STREAM variable=layer149_out depth=1 dim=1
    while(!layer147_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer147_t, layer149_t, config148>(layer147_out, layer149_out, w148, b148);

    static hls::stream<layer151_t> layer151_out[N_FILT_150];
    #pragma HLS STREAM variable=layer151_out depth=1 dim=1
    while(!layer190_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer190_t, layer151_t, config150>(layer190_out2, layer151_out, w150, b150);
    ...
    while(!layer191_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer191_t, layer156_t, config154>(layer191_out1, layer156_out, w154, b154);

    static hls::stream<layer159_t> layer159_out[N_FILT_157];
    #pragma HLS STREAM variable=layer159_out depth=10 dim=1
    while(!layer156_out[0].empty()) nnet::conv_2d_large_cl<layer156_t, layer159_t, config157>(layer156_out, layer159_out, w157, b157);

    static hls::stream<layer161_t> layer161_out[N_FILT_160];
    #pragma HLS STREAM variable=layer161_out depth=1 dim=1
    while(!layer159_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer159_t, layer161_t, config160>(layer159_out, layer161_out, w160, b160);
    ...
    while(!layer192_out1[0].empty()) nnet::conv_2d_large_cl_1x1<layer192_t, layer166_t, config164>(layer192_out1, layer166_out, w164, b164);

    static hls::stream<layer169_t> layer169_out[N_FILT_167];
    #pragma HLS STREAM variable=layer169_out depth=10 dim=1
    while(!layer166_out[0].empty()) nnet::conv_2d_large_cl<layer166_t, layer169_t, config167>(layer166_out, layer169_out, w167, b167);

    static hls::stream<layer171_t> layer171_out[N_FILT_170];
    #pragma HLS STREAM variable=layer171_out depth=1 dim=1
    while(!layer169_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer169_t, layer171_t, config170>(layer169_out, layer171_out, w170, b170);
    ...
    while(!layer173_out[0].empty()) nnet::pooling2d_cl_1x1<layer173_t, layer174_t, config174>(layer173_out, layer174_out);
