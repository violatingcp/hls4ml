...
void myproject_full_layer2_stream_in(
	...
	nnet::load_weights_from_txt<model_default_t, 36864>(w20, "w20.txt");
        ...
        nnet::load_weights_from_txt<model_default_t, 147456>(w29, "w29.txt");//bram
        ...
        nnet::load_weights_from_txt<model_default_t, 294912>(w34, "w34.txt");//bram
    ...
    while(!layer7_out[0].empty())  nnet::conv_2d_large_cl_stream<layer7_t,layer11_t,config11>(layer7_out,layer11_out,w11,b11,s13,b13,alpha);
    ...
    //while(!layer29_out[0].empty()) nnet::pooling2d_cl<layer29_t,layer33_t,config33>(layer29_out,layer52_out);
