...
if {$opt(reset)} {
  open_project -reset myproject_prj_layer
} else {
  open_project myproject_prj_layer
}
set_top myproject_layer
add_files firmware/myproject_layer.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_layer.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_layer.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
