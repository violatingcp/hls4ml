...
if {$opt(reset)} {
  open_project -reset myproject_stream_prj
} else {
  open_project myproject_stream_prj
}
set_top myproject
add_files firmware/myproject_stream.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_stream.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_stream.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
