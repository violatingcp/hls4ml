...
void myproject(
  ...
  //#pragma HLS DATAFLOW
    ...
    #pragma HLS stream variable=sInput      depth=784
    #pragma HLS stream variable=sOutput     depth=144
    bool lReset = true;
...
void subimage_stream(bool iReset, 
    ...
    #pragma HLS stream variable=layer2_out      depth=10
