...
void myproject(
    ...
    layer2_t layer2_in_row[N_FILT_HEIGHT_2*N_INPUT_1_1*N_INPUT_2_1];
    ...
    for(unsigned i0 = 0; i0 < N_INPUT_1_1; i0++) { 
      ...
      nnet::reset_down<input_t,layer4_t,config4>(layer4_in,layer4_in_row);
      ...
      for(unsigned i1 = 0; i1 < N_INPUT_2_1; i1++) { 
       ...
       nnet::shift_right<input_t,input_t,config2>(i1,layer2_in,layer2_in_row);
       ...
       nnet::fill_entry<layer3_t,layer4_t,config4>(i1,layer3_out,layer4_in_row);
       //move the input buffer right one pixel (Perhaps this should go later)
       nnet::shift_right<layer4_t,layer4_t,config4>(i1,layer4_in,layer4_in_row);
       ...
       nnet::fill_entry<layer5_t,layer6_t,config6>(i1,layer5_out,layer6_in_row);
