...
if {$opt(reset)} {
  open_project -reset myproject_rowprj
} else {
  open_project myproject_rowprj
}
set_top myproject_rowlayer
add_files firmware/myproject_rowlayer.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_rowlayer.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_rowlayer.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
