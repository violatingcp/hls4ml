...
int main(int argc, char **argv)
{
  ...
  bool iReset=true;
  hls::stream<input_t>  inputstream[N_INPUT_1_1-1];
  hls::stream<result_t> outputstream[N_FILT_2-1];//175];
  ...
  for(int i1 = 0; i1 < 1; i1++) { 
    for(int i0 = 0; i0 < N_INPUT_1_1-1; i0++) { 
      //if(i0 == 0) { 
  ...
  if(!outputstream[0].empty()) { 
    for(int i1 = 0; i1 < 112*112; i1++) { 
      for(int i0 = 0; i0 < N_FILT_2-1; i0++) { 
