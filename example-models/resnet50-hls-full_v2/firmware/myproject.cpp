...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 18432>(w9, "w9.txt");
        nnet::load_weights_from_txt<bias9_t, 32>(b9, "b9.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w12, "w12.txt");
        nnet::load_weights_from_txt<bias12_t, 128>(b12, "b12.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w14, "w14.txt");
        nnet::load_weights_from_txt<bias14_t, 128>(b14, "b14.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w18, "w18.txt");
        nnet::load_weights_from_txt<bias18_t, 32>(b18, "b18.txt");
        nnet::load_weights_from_txt<model_default_t, 18432>(w21, "w21.txt");
        nnet::load_weights_from_txt<bias21_t, 32>(b21, "b21.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w24, "w24.txt");
        nnet::load_weights_from_txt<bias24_t, 128>(b24, "b24.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w28, "w28.txt");
        nnet::load_weights_from_txt<bias28_t, 32>(b28, "b28.txt");
        nnet::load_weights_from_txt<model_default_t, 18432>(w31, "w31.txt");
        nnet::load_weights_from_txt<bias31_t, 32>(b31, "b31.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w34, "w34.txt");
        nnet::load_weights_from_txt<bias34_t, 128>(b34, "b34.txt");
        nnet::load_weights_from_txt<model_default_t, 16384>(w38, "w38.txt");
        nnet::load_weights_from_txt<bias38_t, 64>(b38, "b38.txt");
        nnet::load_weights_from_txt<model_default_t, 73728>(w41, "w41.txt");
        nnet::load_weights_from_txt<bias41_t, 64>(b41, "b41.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w44, "w44.txt");
        nnet::load_weights_from_txt<bias44_t, 256>(b44, "b44.txt");
        nnet::load_weights_from_txt<model_default_t, 65536>(w46, "w46.txt");
        nnet::load_weights_from_txt<bias46_t, 256>(b46, "b46.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w50, "w50.txt");
        nnet::load_weights_from_txt<bias50_t, 64>(b50, "b50.txt");
        nnet::load_weights_from_txt<model_default_t, 73728>(w53, "w53.txt");
        nnet::load_weights_from_txt<bias53_t, 64>(b53, "b53.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w56, "w56.txt");
        nnet::load_weights_from_txt<bias56_t, 256>(b56, "b56.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w60, "w60.txt");
        nnet::load_weights_from_txt<bias60_t, 64>(b60, "b60.txt");
        nnet::load_weights_from_txt<model_default_t, 73728>(w63, "w63.txt");
        nnet::load_weights_from_txt<bias63_t, 64>(b63, "b63.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w66, "w66.txt");
        nnet::load_weights_from_txt<bias66_t, 256>(b66, "b66.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w70, "w70.txt");
        nnet::load_weights_from_txt<bias70_t, 64>(b70, "b70.txt");
        nnet::load_weights_from_txt<model_default_t, 73728>(w73, "w73.txt");
        nnet::load_weights_from_txt<bias73_t, 64>(b73, "b73.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w76, "w76.txt");
        nnet::load_weights_from_txt<bias76_t, 256>(b76, "b76.txt");
        nnet::load_weights_from_txt<model_default_t, 65536>(w80, "w80.txt");
        nnet::load_weights_from_txt<bias80_t, 128>(b80, "b80.txt");
        nnet::load_weights_from_txt<model_default_t, 294912>(w83, "w83.txt");
        nnet::load_weights_from_txt<bias83_t, 128>(b83, "b83.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w86, "w86.txt");
        nnet::load_weights_from_txt<bias86_t, 512>(b86, "b86.txt");
        nnet::load_weights_from_txt<model_default_t, 262144>(w88, "w88.txt");
        nnet::load_weights_from_txt<bias88_t, 512>(b88, "b88.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w92, "w92.txt");
        nnet::load_weights_from_txt<bias92_t, 128>(b92, "b92.txt");
        nnet::load_weights_from_txt<model_default_t, 294912>(w95, "w95.txt");
        nnet::load_weights_from_txt<bias95_t, 128>(b95, "b95.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w98, "w98.txt");
        nnet::load_weights_from_txt<bias98_t, 512>(b98, "b98.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w102, "w102.txt");
        nnet::load_weights_from_txt<bias102_t, 128>(b102, "b102.txt");
        nnet::load_weights_from_txt<model_default_t, 294912>(w105, "w105.txt");
        nnet::load_weights_from_txt<bias105_t, 128>(b105, "b105.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w108, "w108.txt");
        nnet::load_weights_from_txt<bias108_t, 512>(b108, "b108.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w112, "w112.txt");
        nnet::load_weights_from_txt<bias112_t, 128>(b112, "b112.txt");
        nnet::load_weights_from_txt<model_default_t, 294912>(w115, "w115.txt");
        nnet::load_weights_from_txt<bias115_t, 128>(b115, "b115.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w118, "w118.txt");
        nnet::load_weights_from_txt<bias118_t, 512>(b118, "b118.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w122, "w122.txt");
        nnet::load_weights_from_txt<bias122_t, 128>(b122, "b122.txt");
        nnet::load_weights_from_txt<model_default_t, 294912>(w125, "w125.txt");
        nnet::load_weights_from_txt<bias125_t, 128>(b125, "b125.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w128, "w128.txt");
        nnet::load_weights_from_txt<bias128_t, 512>(b128, "b128.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w132, "w132.txt");
        nnet::load_weights_from_txt<bias132_t, 128>(b132, "b132.txt");
        nnet::load_weights_from_txt<model_default_t, 294912>(w135, "w135.txt");
        nnet::load_weights_from_txt<bias135_t, 128>(b135, "b135.txt");
        nnet::load_weights_from_txt<model_default_t, 131072>(w138, "w138.txt");
        nnet::load_weights_from_txt<bias138_t, 512>(b138, "b138.txt");
        nnet::load_weights_from_txt<model_default_t, 262144>(w142, "w142.txt");
        nnet::load_weights_from_txt<bias142_t, 256>(b142, "b142.txt");
        nnet::load_weights_from_txt<model_default_t, 1179648>(w145, "w145.txt");
        nnet::load_weights_from_txt<bias145_t, 256>(b145, "b145.txt");
        nnet::load_weights_from_txt<model_default_t, 524288>(w148, "w148.txt");
        nnet::load_weights_from_txt<bias148_t, 1024>(b148, "b148.txt");
        nnet::load_weights_from_txt<model_default_t, 1048576>(w150, "w150.txt");
        nnet::load_weights_from_txt<bias150_t, 1024>(b150, "b150.txt");
        nnet::load_weights_from_txt<model_default_t, 524288>(w154, "w154.txt");
        nnet::load_weights_from_txt<bias154_t, 256>(b154, "b154.txt");
        nnet::load_weights_from_txt<model_default_t, 1179648>(w157, "w157.txt");
        nnet::load_weights_from_txt<bias157_t, 256>(b157, "b157.txt");
        nnet::load_weights_from_txt<model_default_t, 524288>(w160, "w160.txt");
        nnet::load_weights_from_txt<bias160_t, 1024>(b160, "b160.txt");
        nnet::load_weights_from_txt<model_default_t, 524288>(w164, "w164.txt");
        nnet::load_weights_from_txt<bias164_t, 256>(b164, "b164.txt");
        nnet::load_weights_from_txt<model_default_t, 1179648>(w167, "w167.txt");
        nnet::load_weights_from_txt<bias167_t, 256>(b167, "b167.txt");
        nnet::load_weights_from_txt<model_default_t, 524288>(w170, "w170.txt");
        nnet::load_weights_from_txt<bias170_t, 1024>(b170, "b170.txt");
        nnet::load_weights_from_txt<model_default_t, 1024000>(w175, "w175.txt");
        nnet::load_weights_from_txt<model_default_t, 500>(b175, "b175.txt");
        loaded_weights = true;
    }
#endif
    ...
    if(!layer11_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer11_t, layer12_t, config12>(layer11_out, layer12_out, w12, b12);
    ...
    if(!layer177_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer177_t, layer14_t, config14>(layer177_out2, layer14_out, w14, b14);
    ...
    #pragma HLS STREAM variable=layer24_out depth=1 dim=1
    static hls::stream<layer25_t> layer25_out[N_FILT_24];
    #pragma HLS STREAM variable=layer25_out depth=1 dim=1
    if(!layer23_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer23_t, layer24_t, config24>(layer23_out, layer24_out, w24, b24);
    ...
    #pragma HLS STREAM variable=layer34_out depth=1 dim=1
    static hls::stream<layer35_t> layer35_out[N_FILT_34];
    #pragma HLS STREAM variable=layer35_out depth=1 dim=1
    if(!layer33_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer33_t, layer34_t, config34>(layer33_out, layer34_out, w34, b34);
    ...
    #pragma HLS STREAM variable=layer44_out depth=1 dim=1
    static hls::stream<layer45_t> layer45_out[N_FILT_44];
    #pragma HLS STREAM variable=layer45_out depth=1 dim=1
    if(!layer43_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer43_t, layer44_t, config44>(layer43_out, layer44_out, w44, b44);

    static hls::stream<layer46_t> layer46_out[N_FILT_46];
    #pragma HLS STREAM variable=layer46_out depth=1 dim=1
    static hls::stream<layer47_t> layer47_out[N_FILT_46];
    #pragma HLS STREAM variable=layer47_out depth=1 dim=1
    if(!layer180_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer180_t, layer46_t, config46>(layer180_out2, layer46_out, w46, b46);
    ...
    #pragma HLS STREAM variable=layer56_out depth=1 dim=1
    static hls::stream<layer57_t> layer57_out[N_FILT_56];
    #pragma HLS STREAM variable=layer57_out depth=1 dim=1
    if(!layer55_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer55_t, layer56_t, config56>(layer55_out, layer56_out, w56, b56);
    ...
    #pragma HLS STREAM variable=layer66_out depth=1 dim=1
    static hls::stream<layer67_t> layer67_out[N_FILT_66];
    #pragma HLS STREAM variable=layer67_out depth=1 dim=1
    if(!layer65_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer65_t, layer66_t, config66>(layer65_out, layer66_out, w66, b66);
    ...
    #pragma HLS STREAM variable=layer76_out depth=1 dim=1
    static hls::stream<layer77_t> layer77_out[N_FILT_76];
    #pragma HLS STREAM variable=layer77_out depth=1 dim=1
    if(!layer75_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer75_t, layer76_t, config76>(layer75_out, layer76_out, w76, b76);
    ...
    #pragma HLS STREAM variable=layer86_out depth=1 dim=1
    static hls::stream<layer87_t> layer87_out[N_FILT_86];
    #pragma HLS STREAM variable=layer87_out depth=1 dim=1
    if(!layer85_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer85_t, layer86_t, config86>(layer85_out, layer86_out, w86, b86);

    static hls::stream<layer88_t> layer88_out[N_FILT_88];
    #pragma HLS STREAM variable=layer88_out depth=1 dim=1
    static hls::stream<layer89_t> layer89_out[N_FILT_88];
    #pragma HLS STREAM variable=layer89_out depth=1 dim=1
    if(!layer184_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer184_t, layer88_t, config88>(layer184_out2, layer88_out, w88, b88);
    ...
    static hls::stream<layer98_t> layer98_out[N_FILT_98];
    #pragma HLS STREAM variable=layer98_out depth=1 dim=1
    static hls::stream<layer99_t> layer99_out[N_FILT_98];
    #pragma HLS STREAM variable=layer99_out depth=1 dim=1
    if(!layer97_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer97_t, layer98_t, config98>(layer97_out, layer98_out, w98, b98);
    ...
    static hls::stream<layer108_t> layer108_out[N_FILT_108];
    #pragma HLS STREAM variable=layer108_out depth=1 dim=1
    static hls::stream<layer109_t> layer109_out[N_FILT_108];
    #pragma HLS STREAM variable=layer109_out depth=1 dim=1
    if(!layer107_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer107_t, layer108_t, config108>(layer107_out, layer108_out, w108, b108);
    ...
    static hls::stream<layer118_t> layer118_out[N_FILT_118];
    #pragma HLS STREAM variable=layer118_out depth=1 dim=1
    static hls::stream<layer119_t> layer119_out[N_FILT_118];
    #pragma HLS STREAM variable=layer119_out depth=1 dim=1
    if(!layer117_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer117_t, layer118_t, config118>(layer117_out, layer118_out, w118, b118);
    ...
    static hls::stream<layer128_t> layer128_out[N_FILT_128];
    #pragma HLS STREAM variable=layer128_out depth=1 dim=1
    static hls::stream<layer129_t> layer129_out[N_FILT_128];
    #pragma HLS STREAM variable=layer129_out depth=1 dim=1
    if(!layer127_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer127_t, layer128_t, config128>(layer127_out, layer128_out, w128, b128);
    ...
    static hls::stream<layer138_t> layer138_out[N_FILT_138];
    #pragma HLS STREAM variable=layer138_out depth=1 dim=1
    static hls::stream<layer139_t> layer139_out[N_FILT_138];
    #pragma HLS STREAM variable=layer139_out depth=1 dim=1
    if(!layer137_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer137_t, layer138_t, config138>(layer137_out, layer138_out, w138, b138);
    ...
    static hls::stream<layer148_t> layer148_out[N_FILT_148];
    #pragma HLS STREAM variable=layer148_out depth=1 dim=1
    static hls::stream<layer149_t> layer149_out[N_FILT_148];
    #pragma HLS STREAM variable=layer149_out depth=1 dim=1
    if(!layer147_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer147_t, layer148_t, config148>(layer147_out, layer148_out, w148, b148);

    static hls::stream<layer150_t> layer150_out[N_FILT_150];
    #pragma HLS STREAM variable=layer150_out depth=1 dim=1
    static hls::stream<layer151_t> layer151_out[N_FILT_150];
    #pragma HLS STREAM variable=layer151_out depth=1 dim=1
    if(!layer190_out2[0].empty()) nnet::conv_2d_large_cl_1x1<layer190_t, layer150_t, config150>(layer190_out2, layer150_out, w150, b150);
    ...
    #pragma HLS STREAM variable=layer160_out depth=1 dim=1
    static hls::stream<layer161_t> layer161_out[N_FILT_160];
    #pragma HLS STREAM variable=layer161_out depth=1 dim=1
    if(!layer159_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer159_t, layer160_t, config160>(layer159_out, layer160_out, w160, b160);
    ...
    #pragma HLS STREAM variable=layer170_out depth=1 dim=1
    static hls::stream<layer171_t> layer171_out[N_FILT_170];
    #pragma HLS STREAM variable=layer171_out depth=1 dim=1
    if(!layer169_out[0].empty()) nnet::conv_2d_large_cl_1x1<layer169_t, layer170_t, config170>(layer169_out, layer170_out, w170, b170);
    ...
    static hls::stream<layer174_t> layer174_out[OUT_HEIGHT_174];
    ...
    if(!layer174_out[0].empty()) nnet::dense_latency<layer174_t, layer175_t, config175>(layer174_out, layer175_out, w175, b175);

    if(!layer175_out[0].empty()) nnet::softmax<layer175_t, result_t, softmax_config176>(layer175_out, layer176_out);
