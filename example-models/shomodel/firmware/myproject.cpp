...
void myproject(
    ...
    nnet::conv_1d_large_cl<input_t, layer2_t, config2>(input1, layer2_out, w2, b2);
    ...
    nnet::conv_1d_large_cl<layer3_t, layer4_t, config4>(layer3_out, layer4_out, w4, b4);
